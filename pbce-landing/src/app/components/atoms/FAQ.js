        ...
        >
            ...
            <Box sx={{ width: '100%' }}>
                ...
                >
                    ...
                    >
                        <Typography component="h3" variant="subtitle2">
                            What if the order/restaurant I want isn't on the list?
                        </Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                        <Typography
                            ...
                            sx={{ maxWidth: { sm: '100%', md: '70%' } }}
                        >
                            You can directly contact us at 928-257-8808 or just add your
                            specific order details to the order form.
                        </Typography>
                    </AccordionDetails>
                </Accordion>
                <Accordion
